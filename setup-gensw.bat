...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%GENSW_ROOT%scripts\local\setup-gensw.ps1" %*
set "GENSW_EXIT_CODE=%ERRORLEVEL%"

if not "%GENSW_EXIT_CODE%"=="0" (
  echo.
  echo [GenSW] O setup falhou. Consulte a mensagem acima e tente novamente.
