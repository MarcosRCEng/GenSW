...
namespace GenSW.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912152820_AddIdentificacoesAnimal")]
    partial class AddIdentificacoesAnimal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenSW.Domain.Animals.IdentificacaoAnimal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IdentificacoesAnimal", null, t =>
                        {
                            t.HasCheckConstraint("CK_IdentificacoesAnimal_DescricaoTipo_Semantics", "(\"Tipo\" IN (1, 2, 3, 4, 5) AND \"DescricaoTipo\" IS NULL) OR (\"Tipo\" = 6 AND \"DescricaoTipo\" IS NOT NULL AND \"DescricaoTipo\" <> '' AND \"DescricaoTipo\" = btrim(\"DescricaoTipo\"))");
            ...
            modelBuilder.Entity("GenSW.Domain.People.Pessoa", b =>
                {
                    ...
                    b.ToTable("Pessoas", null, t =>
                        {
                            t.HasCheckConstraint("CK_Pessoas_TipoPessoa", "\"TipoPessoa\" IN (1, 2)");
                        });
                });

            modelBuilder.Entity("GenSW.Domain.Species.Especie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GenSW.Domain.Varieties.Variedade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Variedades", null, t =>
                        {
                            t.HasCheckConstraint("CK_Variedades_Nome_Canonical", "\"Nome\" <> '' AND \"Nome\" !~ U&'[\\0009-\\000D\\0085\\00A0\\1680\\2000-\\200A\\2028\\2029\\202F\\205F\\3000]' AND \"Nome\" !~ '(^ | $|  )'");
                        });
                });
